			          ...
			          <div className="col-lg-4">
			            <ul className="nav nav-tabs tp-tabs style-two">
			              <li className="nav-item">
			                <Link className="nav-link active" data-toggle="tab" to="#tabs_1"><i className="fa fa-user" />Profile</Link>
			              </li>
			              <li className="nav-item">
			                <Link className="nav-link" data-toggle="tab" to="#tabs_2"><i className="fa fa-check-square-o" />Verifications</Link>
			              </li>
			              <li className="nav-item">
			                <Link className="nav-link" data-toggle="tab" to="#tabs_3"><i className="fa fa-cog" />Settings</Link>
			              </li>
			              <li className="nav-item">
			                <Link className="nav-link" data-toggle="tab" to="#tabs_4"><i className="fa fa-recycle" />Recently Viewed</Link>
			              </li>
			              <li className="nav-item">
			                <Link className="nav-link" data-toggle="tab" to="#tabs_5"><i className="fa fa-credit-card-alt" />Payment Methods</Link>
			              </li>
			              <li className="nav-item">
			                <Link className="nav-link" data-toggle="tab" to="#tabs_6"><i className="fa fa-star-o" />Reviews</Link>
			              </li>
			              <li className="text-center">
			                <Link className="btn btn-yellow" to="#"><i className="fa fa-sign-in" aria-hidden="true" /> <span>Log Out</span></Link>
			              </li>
			            </ul>
			          </div>
			                      ...
			                      <div className="row">
			                        ...
			                        <div className="col-lg-5">
			                          <div className="user-payment-card">
			                            <img src={require("../../../assets/img/others/16.png")} alt="img" />
			                            ...
			                            <Link className="btn btn-transparent" to="#">Cancel</Link>
			                            <Link className="btn btn-yellow" to="#">Save</Link>
			                          </div>
			                        </div>
			                      </div>
			                    </form>
