			    ...
			    <div className="row justify-content-center">
			      <div className="col-lg-4 col-md-6">
			        <div className="single-destination-grid style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/destination-list/17.png")} alt="img" />
			          </div>
			          <div className="details">
			            <ul className="d-list-meta">
			              <li className="date">2019</li>
			              <li><img src={require("../../../assets/img/icons/13.png")} alt="img" /> 550+ Tour Complite</li>
			              <li><img src={require("../../../assets/img/icons/14.png")} alt="img" /> 25+ Awards Win</li>
			            </ul>
			      ...
			      <div className="col-lg-4 col-md-6">
			        <div className="single-destination-grid style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/destination-list/18.png")} alt="img" />
			          </div>
			          <div className="details">
			            <ul className="d-list-meta">
			              <li className="date">2019</li>
			              <li><img src={require("../../../assets/img/icons/13.png")} alt="img" /> 120+ Tour Complite</li>
			              <li><img src={require("../../../assets/img/icons/14.png")} alt="img" /> 25+ Awards Win</li>
			            </ul>
			      ...
			      <div className="col-lg-4 col-md-6">
			        <div className="single-destination-grid style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/destination-list/19.png")} alt="img" />
			          </div>
			          <div className="details">
			            <ul className="d-list-meta">
			              <li className="date">2019</li>
			              <li><img src={require("../../../assets/img/icons/13.png")} alt="img" /> 130+ Tour Complite</li>
			              <li><img src={require("../../../assets/img/icons/14.png")} alt="img" /> 25+ Awards Win</li>
			            </ul>
