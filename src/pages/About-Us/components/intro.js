			    ...
			    <div className="row">
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/icons/9.png")} alt="img" />
			          </div>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/icons/10.png")} alt="img" />
			          </div>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/icons/11.png")} alt="img" />
			          </div>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          <div className="thumb">
			            <img src={require("../../../assets/img/icons/12.png")} alt="img" />
			          </div>
