...
class Video extends Component {
    ...
    return  <div className="video-area tp-video-area pd-top-110" style={{backgroundImage: 'url('+require('../../../assets/img/bg/7.png')+')'}}>
			    ...
			    <div className="row">
			      <div className="col-xl-5 col-lg-6 align-self-center wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
			        <div className="section-title mb-lg-0 mb-4 text-center text-lg-left">
			          ...
			          <Link className="btn btn-yellow" to="/about-us"><span>Read More<i className="la la-arrow-right" /></span></Link>
			        </div>
			      </div>
