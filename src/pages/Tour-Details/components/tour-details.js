                    ...
                    <div className="tour-details-wrap">
                        ...
                        <div className="row">
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/15.png")} alt="icons" />
                              <h6>Food</h6>
                          ...
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/16.png")} alt="icons" />
                          ...
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/17.png")} alt="icons" />
                          ...
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/18.png")} alt="icons" />
                              <h6>Drinks</h6>
                          ...
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/19.png")} alt="icons" />
                              <h6>Tickets</h6>
                              <p>Entrance fee</p>
                            </div>
                          </div>
                          <div className="col-xl-4 col-sm-6">
                            <div className="single-package-included">
                              <img src={require("../../../assets/img/icons/20.png")} alt="icons" />
                              <h6>Equipment</h6>
                        ...
                        <div className="row">
                          <div className="col-lg-4 col-md-4">
                            <div className="single-blog">
                              ...
                              <div className="single-blog-details">
                                ...
                                <Link className="btn-read-more" to="#"><span>Show More<i className="la la-arrow-right" /></span></Link>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-4">
                          ...
                          <div className="col-lg-4 col-md-4">
                            <div className="single-blog single-blog-after-none">
                              ...
                              <div className="thumb">
                                <img src={require("../../../assets/img/blog/9.png")} alt="blog" />
                              </div>
                              <div className="single-blog-details">
                      ...
                      <div className="host-area">
                        <div className="single-host-wrap text-center">
                          <div className="thumb">
                            <img src={require("../../../assets/img/client/02.png")} alt="img" />
                          </div>
                          ...
                          <Link className="btn btn-yellow" to="#">Contact Host</Link>
                        </div>
                      </div>
