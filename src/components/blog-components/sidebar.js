            ...
            <aside className="sidebar-area sidebar-area-4">
              ...
              <div className="widget widget-recent-post">
                ...
                <ul>
                  <li>
                    <div className="media">
                      <img src={require("../../assets/img/blog-details/12.png")} alt="widget" />
                  ...
                  <li>
                    <div className="media">
                      <img src={require("../../assets/img/blog-details/13.png")} alt="widget" />
                      <div className="media-body">
                  ...
                  <li>
                    <div className="media">
                      <img src={require("../../assets/img/blog-details/14.png")} alt="widget" />
                      <div className="media-body">
                  ...
                  <li>
                    <div className="media">
                      <img src={require("../../assets/img/blog-details/15.png")} alt="widget" />
                      <div className="media-body">
                        <span className="post-date">20 July 2019</span>
              ...
              <div className="widget_ads">
                <Link to="/tour-details"><img className="w-100" src={require("../../assets/img/others/01.png")} alt="img" /></Link>
              </div>
            </aside>
          </div>
    )
