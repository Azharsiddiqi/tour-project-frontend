		    ...
		    <div className="row">
		      <div className="col-lg-8">
		        <div className="single-blog mb-0">
		          <div className="thumb">
		            <img src={require("../../assets/img/blog-details/1.png")} alt="blog" />
		          </div>
		            ...
		            <div className="gallery-filter-area row custom-gutter">
		              ...
		              <div className="tp-gallery-item col-md-4 col-sm-6 mb-10">
		                <div className="tp-gallery-item-img">
		                  <img src={require("../../assets/img/blog-details/2.png")} alt="image" />
		                </div>
		              </div>
		              {/* gallery-item */}
		              <div className="tp-gallery-item col-md-4 col-sm-6">
		                <div className="tp-gallery-item-img">
		                  <img src={require("../../assets/img/blog-details/3.png")} alt="image" />
		                </div>
		              </div>
		              {/* gallery-item */}
		              <div className="tp-gallery-item col-md-4 col-sm-6">
		                <div className="tp-gallery-item-img">
		                  <img src={require("../../assets/img/blog-details/4.png")} alt="image" />
		                </div>
		              </div>
		              {/* gallery-item */}
		              <div className="tp-gallery-item col-md-4 col-sm-6">
		                <div className="tp-gallery-item-img">
		                  <img src={require("../../assets/img/blog-details/5.png")} alt="image" />
		                </div>
		              </div>
		              {/* gallery-item */}
		              <div className="tp-gallery-item col-md-4 col-sm-6">
		                <div className="tp-gallery-item-img">
		                  <img src={require("../../assets/img/blog-details/6.png")} alt="image" />
		                </div>
		              </div>
		            </div>
		          </div>
		        ...
		        <div className="video-popup-wrap style-two">
		          <div className="thumb">
		            <img src={require("../../assets/img/blog-details/7.png")} alt="video" />
		          </div>
		        ...
		        <div className="row tag-share-area">
		          <div className="col-lg-6">
		            ...
		            <ul className="social-icon style-two">
		              <li>
		                <Link className="facebook" to="#"><i className="fa fa-facebook" /></Link>
		              </li>
		              <li>
		                <Link className="twitter" to="#"><i className="fa fa-twitter" /></Link>
		              </li>
		              <li>
		                <Link className="pinterest" to="#"><i className="fa fa-instagram" /></Link>
		              </li>
		              <li>
		                <Link className="linkedin" to="#"><i className="fa fa-linkedin" /></Link>
		              </li>
		            </ul>
		          </div>
		        ...
		        <div className="author-area media">
		          <div className="media-left">
		            <img src={require("../../assets/img/blog-details/8.png")} alt="img" />
		          </div>
		          ...
		          <ul className="comment-list">
		            <li>
		              <div className="single-comment-wrap">
		                <div className="thumb">
		                  <img src={require("../../assets/img/blog-details/9.png")} alt="img" />
		                </div>
		                <div className="content">
		                  <h4 className="title">Tyler Bailey</h4>
		                  <span className="date">17 SEP 2019</span>
		                  <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr</p>
		                  <Link to="#" className="reply btn btn-yellow"><span><i className="fa fa-reply" />Reply</span></Link>
		                </div>
		              </div>
		            </li>
		            <li>
		              <ul className="children">
		                <li>
		                  <div className="single-comment-wrap">
		                    <div className="thumb">
		                      <img src={require("../../assets/img/blog-details/10.png")} alt="img" />
		                    </div>
		                    <div className="content">
		            ...
		            <li>
		              <div className="single-comment-wrap">
		                <div className="thumb">
		                  <img src={require("../../assets/img/blog-details/11.png")} alt="img" />
		                </div>
		                <div className="content">
		          ...
		          <form className="tp-form-wrap bg-gray tp-form-wrap-one">
		            ...
		            <div className="row">
		              ...
		              <div className="col-12">
		                <Link className="btn btn-yellow" to="#">Send Comment</Link>
		              </div>
		            </div>
		          </form>
		        </div>
